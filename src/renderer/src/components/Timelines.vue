<template>
  <v-sheet class="d-flex flex-1-1 flex-column height-min-0">
    <div class="d-flex flex-1-1 flex-row height-min-0">
      <!-- Vertical segment toolbar -->
      <div class="align-center d-flex flex-column segment-toolbar">
        <!-- Eye: hidden tracks -->
            ...
            >
              ...
              >
                <span class="eye-btn-wrap">
                  ...
                  <span v-if="hiddenTimelineIds.length > 0" class="eye-count">{{
                    hiddenTimelineIds.length
                  }}</span>
                </span>
              </v-btn>
            </span>
                          ...
                          >
                            <template #title>
                              <div class="track-name-wrap">
                                ...
                                <div
                                  v-if="overflowingTracks[category.id]"
                                  class="track-name-popover"
                                >
                                  {{ category.name }}
                                </div>
                              </div>
